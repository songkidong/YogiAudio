				...
				<div class="col-md-4 col-xs-6">
					<div class="shop">
						<a href="javascript:void(0)"
							onclick="openModal('${mvlist.mvfile}/')" class="cta-btn">
							<div class="shop-img">
								<img src="/main/img/IU1.jpg"
						...
						<div class="shop-body">
							...
							<a href="javascript:void(0)"
								onclick="openModal('${mvlist.mvfile}/')" class="cta-btn">MV보기<i
									...
									<div class="product">
										...
										<div class="product-body">
											...
											<h3 class="product-name">
												<a
													href="/product/domestic-detail?musicno=${dnewlist.musicno}&musicmajor=${dnewlist.musicmajor}&id=${principal.id}">
													${dnewlist.musictitle} </a>
											</h3>
								...
								<c:forEach var="anewlist" items="${anewlist}">
									<div class="product">
										...
										<div class="product-body">
											...
											<h3 class="product-name">
												<a
													href="/product/domestic-detail?musicno=${anewlist.musicno}&musicmajor=${anewlist.musicmajor}&id=${principal.id}">
													${anewlist.musictitle} </a>
											</h3>
...
<div id="banner-section">
	<div class="row"
		style="display: flex; justify-content: center; align-items: center; position: relative; height: 300px; overflow: hidden;">
		<img src="/main/banner/banner1.png" class="banner-image"
			style="width: 1150px; height: 300px; opacity: 1; position: absolute; left: 50%; top: 0; transform: translateX(-50%);">
		<img src="/main/banner/banner2.png" class="banner-image"
			style="width: 1150px; height: 300px; opacity: 0; position: absolute; left: 50%; top: 0; transform: translateX(-50%);">
	</div>
</div>
<!-- /HOT DEAL SECTION -->
...
<script>
	$(document).ready(function() {
		var currentIndex = 0, images = $('.banner-image');
		...
		setInterval(function() {
			...
			nextImage.css('opacity', 0).css('display', 'block').animate({
				opacity : 1
			}, 1000);
