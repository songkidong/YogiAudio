...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.4.10/dist/sweetalert2.min.js"></script>    
	...
	<form action="/product/dalbum-update" method="post" enctype="multipart/form-data">
		    ...
		    <div class="col-md-8">
		      <div class="card-body">
		        ...
		        <div class="row" style ="margin-top: 30px;">
				    ...
				    <div class="col-md-5">
				        <div class="input-box">
				            <input type="text" class="form-control" name ="musicno" id="user_no_input" >
				        </div>
				    </div>
				  </div>
