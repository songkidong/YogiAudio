	...
	<!--/ Hoverable Table rows -->
              ...
              <ul class="pagination" style="display: flex; justify-content: center; padding-right: 10%; margin-top: 10px;">
				  ...
				  <c:if test="${pageVO.prev }">
				  	<li class="page-item">
				  		<a class="page-link" href="/admin/noticeList?page=${pageVO.startPage - 1 }"><i class="fas fa-chevron-left"></i></a>
				  	</li>
				  </c:if>
				  ...
				  <li class="page-item ${pageVO.cri.page eq i ? 'active' : ''}">
				  	...
				  	<a class="page-link" href="/admin/noticeList?page=${i }">${i }</a>
				  </li>
				  </c:forEach>
				  <!-- 반복문 끝 -->
				  ...
				  <c:if test="${pageVO.next }">
				  	<li class="page-item">
				  		<a class="page-link" href="/admin/noticeList?page=${pageVO.endPage + 1 }"><i class="fas fa-chevron-right"></i></a>
				  	</li>
				  </c:if>
...
<script src="/js/admin/noticelist.js"></script>
