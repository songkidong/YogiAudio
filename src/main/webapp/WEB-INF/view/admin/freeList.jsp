                  ...
                  <table class="table table-hover">
                    ...
                    <!-- 반복문 -->
	               		<c:forEach var="free" items="${freeList }">
		                 	<tr>
		            		  <td>${free.id}</td>
		            		  <td>${free.writerName}</td>
		            		  <td><a href="/admin/freeView/${free.id }">${free.title}</a></td>
		            		  <td>${free.hit}</td>
	...
	<!--/ Hoverable Table rows -->
              ...
              <ul class="pagination" style="display: flex; justify-content: center; padding-right: 10%;	margin-top: 5%;">
				  ...
				  <c:if test="${pageVO.prev }">
				  	<li class="page-item">
				  		<a class="page-link" href="/admin/freeList?page=${pageVO.startPage - 1 }"><i class="fas fa-chevron-left"></i></a>
				  	</li>
				  </c:if>
				  ...
				  <li class="page-item ${pageVO.cri.page eq i ? 'active' : ''}">
				  	...
				  	<a class="page-link" href="/admin/freeList?page=${i }">${i }</a>
				  </li>
				  </c:forEach>
				  <!-- 반복문 끝 -->
				  ...
				  <c:if test="${pageVO.next }">
				  	<li class="page-item">
				  		<a class="page-link" href="/admin/freeList?page=${pageVO.endPage + 1 }"><i class="fas fa-chevron-right"></i></a>
				  	</li>
				  </c:if>
...
<script src="/js/admin/freelist.js"></script>
