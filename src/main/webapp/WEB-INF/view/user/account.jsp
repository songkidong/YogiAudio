        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">마이페이지 /</span> 계정</h4>
                      ...
                      <form action="/updateUser/${principal.id}" method="POST" >
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="nickname" id="nickname" value="${principal.nickname}" />
                          </div>
                          <div class="mb-3 col-md-6">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              id="status"
                              name="status"
                              value="${principal.status == 'Y' ? '구독중' : '구독안함'}" readonly />
                          </div>
                          <div class="mb-3 col-md-6">
