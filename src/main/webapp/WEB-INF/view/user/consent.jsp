<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<link rel="stylesheet" href="css/user/consent.css" />
<%@include file="/WEB-INF/view/layout/header.jsp"%>
<div class= "container">
    <div class="wrap">
      <div class="logo"><h1>YogiAudio</h1></div>
      <div class="contents">
        <form action="/signUp" method="POST" id="form__wrap">
          <div class="terms__check__all">
            <input type="checkbox" name="checkAll" id="checkAll" />
            <label for="checkAll"
              >요기오디오 이용약관에 모두 동의합니다.</label
            >
          </div>
          <ul class="terms__list">
            <li class="terms__box">
              ...
              <div class="terms__content">
                여러분을 환영합니다. 요기오디오 서비스 및 제품(이하 ‘서비스’)을 이용해
                주셔서 감사합니다. 본 약관은 다양한 JUN 서비스의 이용과 관련하여
                요기오디오 서비스를 제공하는 요기오디오 주식회사(이하 요기오디오)와 이를 이용하는
                요기오디오 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며,
                아울러 여러분의 요기오디오 서비스 이용에 도움이 될 수 있는 유익한
                정보를 포함하고 있습니다. 요기오디오 서비스를 이용하시거나 요기오디오 서비스
            ...
            <li class="terms__box">
              ...
              <div class="terms__content">
                개인정보보호법에 따라 요기오디오에 회원가입 신청하시는 분께 수집하는
                ...
                대부분의 요기오디오 서비스를 회원과 동일하게 이용할 수 있습니다.
                이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제
                서비스를 이용하기 위해 회원가입을 할 경우, 요기오디오는 서비스
            ...
            <li class="terms__box">
              ...
              <div class="terms__content">
                요기오디오에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(요기오디오앱
                알림 또는 문자), 이메일로 받아보실 수 있습니다. 일부 서비스(별도
                회원 체계로 운영하거나 요기오디오 가입 이후 추가 가입하여 이용하는
          ...
          <button type="submit" class="next-button" disabled>회원가입</button>
        </form>
      </div>
    </div>
    </div>
