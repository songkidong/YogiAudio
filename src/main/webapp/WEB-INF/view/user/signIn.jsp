...
<div class="container sign--in--container-custom">
    ...
    <div class="separator-custom">
        <p>OR</p>
        <div>
            <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=d4f846759e28d648d1c4296141742ccb&redirect_uri=http://localhost/kakao/login" class="kakaoLogin"> <img src="/img/kakao/kakao_login.png" alt="Kakao" id="loginBtn-custom">
            <a href="https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=cLVvs14822OOyYydIWA1&state=STATE_STRING&redirect_uri=http://localhost:80/naver/login" class="naverLogin-custom"> <img src="/img/naver/naver_login.png" alt="Naver" id="loginBtn-custom">
            ...
            " class="googleLogin-custom"> <img src="/img/google/google_login.png" alt="Google" id="loginBtn-custom">
        </div>
    </div>
</div>
